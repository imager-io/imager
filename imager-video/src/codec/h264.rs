...
pub unsafe fn encode(stream: VideoBuffer) -> Result<Vec<u8>, String> {
    ///////////////////////////////////////////////////////////////////////////
    // SETUP
    ///////////////////////////////////////////////////////////////////////////
...
pub fn run() {
    ...
    let source = VideoBuffer::open("assets/samples/test.h264")
        .expect("decode video file");
    let output = unsafe {encode(source).expect("encode faild")};
